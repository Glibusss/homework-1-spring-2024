...
* При уменьшении окна по горизонтали до:  
    - 1199px, меняются растояния между элементами меню и их размеры  
    - 1061px, меняются растояния между элементами меню и их размеры
    - 575px, пропадают изображения рядом с полями ввода, меняются растояния между элементами меню и их размеры
...
* При уменьшении окна по горизонтали до:  
    - 1199px, меняются растояния между элементами меню и их размеры, уменьшаются изображения по сторонам 
    - 1061px, меняются растояния между элементами меню и их размеры, пропадают изображения по сторонам 
    - 575px, пропадают изображения рядом с полями ввода, меняются растояния между элементами меню и их размеры, пропадает текст "Регистрация"
* Уменьшение окна по горизонтали ограничено, по вертикали нет
* В мобильной версии отсутствуют изображения рядом с полями ввода
