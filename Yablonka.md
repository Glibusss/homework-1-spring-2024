...
* Для перехода на [страницу регистрации](https://nota-tabula.ru/signup), нужно нажать на кнопку "Регистрация"
...
* Нажатие перенаправляет на страницу [страницу досок](https://nota-tabula.ru/main)
...
* При переходе авторизованным пользователем на существующую доску, в которую он добавлен, пользователь перенаправляется на [страницу доски](https://nota-tabula.ru/workspace/17/board/29)
