...
* При вводе небольшого количества символов в названии рабочего пространства надпись корректно отображается, розовый квадрат имеет внутри первую букву названия рабочего пространства
...
email пользователя, после чего по нажатию кнопки "Удалить" происходит удаление пользователя с доски. _Баг_ - после удаления пользователя с доски у него не пропадает рабочее пространство при условии, что это была единственная доска, куда добавили пользователя в данном рабочем пространстве
