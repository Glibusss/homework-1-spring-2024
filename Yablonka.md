...
* При уменьшении окна по горизонтали до:  
    * 1199px, немного меняются растояния между элементами меню и их размеры  
    * 1061px, немного меняются растояния между элементами меню и их размеры
    * 575px, пропадают изображения рядом с полями ввода, немного меняются растояния между элементами меню и их размеры
...
* При уменьшении окна по горизонтали до:  
    * 1199px, немного меняются растояния между элементами меню и их размеры, уменьшаются изображения по сторонам 
    * 1061px, немного меняются растояния между элементами меню и их размеры, пропадают изображения по сторонам 
    * 575px, пропадают изображения рядом с полями ввода, немного меняются растояния между элементами меню и их размеры, пропадает текст "Регистрация"
* Уменьшение окна по горизонтали ограничено, по вертикали нет
* В мобильной версии отсутствуют изображения рядом с полями ввода
...
* При сохранении файла с неподдерживаемым форматом (Например ".mp4") и весом 2446 Кб при выборе фильтра "Все типы (*.*)" отображается предупреждение о недопустимом типе выводится предупреждение о недопустимом формате. _Баг - аватар сохраняется_


# [Страница доски](https://nota-tabula.ru/workspace/17/board/29)
...
* _Баг_ - при таком варианте перехода страница некорректно заносится в историю посещений, что приводит к некорректному отображению title у доски
на вкладке браузера
...
* При нажатии в левом боковом меню на кнопку с тремя точками справа от надписи "Настройки доски" справа от иконки открывается окно.
    * При нажатии на вкладку "Удалить доску", пользователя перенаправляет на страницу досок, сама доска исчезает.
...
# [История изменений](https://nota-tabula.ru/workspace/17/board/29)
...
# [Модальное окно карточки](https://nota-tabula.ru/workspace/17/board/29/card/119)

## Общее

* ![Модальное окно карточки](./images/1.png)

* Ссылка указана лишь на саму карточку, т.к. её внутренние элементы не имеют ссылок (для доступа к карточке необходимо авторизоваться и быть приглашённым на соответствующую доску)

* Некорректное название/символы - это текст, не соответствующий условию "Может содержать лишь буквы кириллицы и латиницы, цифры, спецсимволы $@!?#^:;%'"\*_ и быть не пустым"
...
* При клике на название карточки необходимо изменить её название.
    ...
    * При большом названии карточки появляется scrollbar.
    * ![Scrollbar при большом названии карточки](./images/2.1.png)
...
* При нажатии на кнопку "+" открывается модальное окно создания/прикрепления тега.
    ...
    * При вводе недопустимых символов в названии тега выводится сообщение об ошибке: "Некорректное название тега".
