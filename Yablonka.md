...
* ![Scrollbar карточки](./img/1.1.png)
...
* При нажатии на кнопку "+" открывается модальное окно создания/прикрепления тега.
    ...
    * ![Сообщение об ошибке при большом названии тега](./img/3.1.png)
    * При ввобще недопустимых символов в названии тега выводится сообщение об ошибке: "Некорректное название тега".
    * ![Сообщение об ошибке при некорректном названии тега](./img/3.2.png) 
...
* При клике на текстовое поле под "Описание карточки" можно изменить её описание.
    ...
    * ![Scrollbar описания карточки](./img/5.1.png)
    * Допускаются к вводу все символы.

### Поле добавления комментария

* ![Поле добавления комментария карточки](./img/6.png)
...
* При клике на текстовое поле под "Действия" можно оставить комментарий.
    ...
    * ![Сообщение об ошибке при вводе комментария](./img/6.1.png)
    ...
    * ![Ввод максимального по размеру комментария](./img/6.2.png)
...
* При нажатии на кнопку "Даты" открывается модальное окно для добавления дат карточки.
    ...
    * При нажатии на кнопку "Удалить" внизу модального окна даты карточки (при наличии) справа от названия карточки удалятся.
        ...
        * ![Неверная установка месяца даты](./img/14.1.png)
