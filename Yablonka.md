...
* При вводе слишком длинного названия(которое не вмещается в список), оно обрывается с троеточием на конце. _Баг_ - три точки в правом верхнем углу списка уменьшаются.
