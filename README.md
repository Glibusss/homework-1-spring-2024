...
### Getting Started
1. Разбиться на команды (макс. 4 человека). Записаться в [табличку](https://docs.google.com/spreadsheets/d/1Vsy0XF9kQVT1QjSbYQaXIzIbC2RqMM9Bm_5OKjve60w/edit?usp=sharing) *(колонку "Ассистент" не заполняем!)*
